...
module.exports = {
    ...
    run: async (client, message, args) => {
        try {
            if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("**You Dont Have Permmissions To Mute Someone! - [MANAGE_MESSAGES]**");

            if (!message.guild.me.hasPermission("MANAGE_MESSAGES")) return message.channel.send("**I Don't Have Permissions To Mute Someone! - [MANAGE_MESSAGES]**")
